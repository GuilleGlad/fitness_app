...
const {addRecipe, listRecipes, getRecipe, updateRecipe, deleteRecipe, listPublicRecipes} = require('../../controllers/recipesController');
...
router.get('/list-public', listPublicRecipes);
