...
const { listByClient, assignWorkout, deassignWorkout, updateDailyWorkout, listByTrainer, deleteWorkout, addWorkout, updateWorkout} = require('../../controllers/workoutsController');

//WORKOUTS - /workouts
router.get('/list/:client_id', authenticateMiddleware, authorizeMiddleware('trainer','admin'), listByClient);
